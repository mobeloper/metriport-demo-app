 ...
 * Get /body
 *
 * Gets all the body data for the user for the specified date.
 *
 * @param   {string}  date  The date to pull body data for.
 *
 * @return  {object}  The body data.
 */
router.get("/", async (req: Request, res: Response) => {
  ...
  try {
    ...
    const data = await metriportClient.getBodyData(user.metriportUserId, date);
